...
- (BOOL)isBlank {
    if (!self) {
        ...
        return ![self stringByTrimmingCharactersInSet:characterSet].length;
    }
}
...
- (NSInteger)smallLengthHash {
    ...
    return [NSString stringWithFormat:@"%zd",hash].integerValue;;
}

- (NSInteger )getCharLength {
    int stringlength = 0;
    char *character = (char *)[self cStringUsingEncoding:NSUnicodeStringEncoding];
